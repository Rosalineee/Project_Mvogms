                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-12">
                        ...
                        <div class="d-flex w-100">
                            <div class="col-auto px-0"><small class="text-muted">Nhà cung cấp: </small></div>
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><small class="text-muted"><?= $vendor ?></small></p></div>
                        </div>
                        <div class="d-flex">
                            <div class="col-auto px-0"><small class="text-muted">Danh mục: </small></div>
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><small class="text-muted"><?= $category ?></small></p></div>
                        </div>
                        <div class="d-flex">
