...
<script>
	$(document).ready(function(){
		...
		$('.view_data').click(function(){
			uni_modal('Xem sản phẩm chi tiết',"products/view_product.php?id="+$(this).attr('data-id'),'large')
		})
		$('.edit_data').click(function(){
			uni_modal('Cập nhật sản phẩm',"products/manage_product.php?id="+$(this).attr('data-id'),'large')
		})
		$('.delete_data').click(function(){
			_conf("Bạn có thực sự muốn xóa sản phẩm này vĩnh viễn?","delete_product",[$(this).attr('data-id')])
		})
