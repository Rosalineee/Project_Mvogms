                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <thead>
                            <tr class="">
                                ...
                                <th class="text-center align-middle py-1">Tổng giá</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
...
<div class="d-flex align-items-center">
    ...
    <div class="col-auto flex-shrink-1 flex-grow-1 px-4">
        ...
        <h5 class="text-center m-0">THÁNG <?= date("m Y", strtotime($month)) ?></h5>
    </div>
</div>
<hr>
</noscript>
<script>
    $(function(){
        ...
        $('#print').click(function(){
            ...
            head.find('title').text("Báo cáo đơn hàng - Xem bản in")
            el.append(head)
            el.append(header)
            el.append(p)
