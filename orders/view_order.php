...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-3 border bg-gradient-primary"><span class="">Nhà cung cấp</span></div>
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($shop_name) ? $vcode.' - '.$shop_name : '' ?></span></div>
        <div class="col-3 border bg-gradient-primary"><span class="">Địa chỉ giao hàng</span></div>
            ...
            $status = isset($status) ? $status : '';
                switch($status){
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        echo '<span class="badge badge-success bg-gradient-success px-3 rounded-pill">Đã nhận</span>';
                        break;
                    case 5:
	...
	<div class="text-right">
        <?php if(isset($status) && $status == 0): ?>
		    <button class="btn btn-default bg-gradient-danger text-light btn-sm btn-flat" type="button" id="cancel_order">Hủy đơn</button>
        <?php endif; ?>
