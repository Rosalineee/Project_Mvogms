...
<div class="content py-3">
    <div class="card card-outline card-navy shadow rounded-0">
        <div class="card-header">
            <h5 class="card-title">Báo cáo đơn hàng hàng tháng</h5>
        </div>
        <div class="card-body">
                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <thead>
                            <tr class="">
                                ...
                                <th class="text-center align-middle py-1">Mã đơn hàng</th>
                                <th class="text-center align-middle py-1">Khách hàng</th>
                                <th class="text-center align-middle py-1">Nhà cung cấp</th>
                                <th class="text-center align-middle py-1">Trạng thái</th>
                                <th class="text-center align-middle py-1">Tổng tiền</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                                        ...
                                        <?php 
                                            switch($row['status']){
                                                ...
                                                case 2:
                                                    ...
                                                    break;
                                                case 3:
                                                    echo '<span class="badge badge-warning bg-gradient-warning px-3 rounded-pill">Đang vận chuyển</span>';
                                                    break;
                                                case 4:
                                                    echo '<span class="badge badge-success bg-gradient-success px-3 rounded-pill">Đã nhận hàng</span>';
                                                    break;
                                                case 5:
                                                    echo '<span class="badge badge-danger bg-gradient-danger px-3 rounded-pill">Hủy đơn</span>';
                                                    break;
                                                default:
...
<div class="d-flex align-items-center">
    ...
    <div class="col-auto flex-shrink-1 flex-grow-1 px-4">
        ...
        <h3 class="text-center m-0"><b>BÁO CÁO ĐƠN HÀNG</b></h3>
      
        <h5 class="text-center m-0">THÁNG <?= date("n Y", strtotime($month)) ?></h5>
    </div>
</div>
<hr>
</noscript>
<script>
    $(function(){
        ...
        $('#print').click(function(){
            ...
            head.find('title').text("BÁO CÁO ĐƠN HÀNG HÀNG THÁNG - XEM BẢN IN")
            el.append(head)
            el.append(header)
            el.append(p)
